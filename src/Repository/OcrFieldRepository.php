...
class OcrFieldRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function findFirstTmpOcrText($dossier, $entreprise_id, $filename, $offset=1, $limit=30){
        ...
        $sql = "SELECT name, entreprise_id, filename, dossier FROM (SELECT * FROM tmp_ocr WHERE id >= :offset ORDER BY position_top ASC LIMIT $limit) as A WHERE A.filename = :filename and A.dossier = :dossier AND A.entreprise_id = :entreprise_id ORDER BY position_top, position_left ASC";
